...
|---|--------|-----------|--------|--------------|------|
| 1 | 推し活 | レビュー待ち | [oshi-katsu](https://github.com/marutamura/oshi-katsu) | セキュリティレビュー | 孔雀 |
| 2 | 目標達成部 | レビュー待ち | [mokuhyo-tassei-bu](https://github.com/marutamura/mokuhyo-tassei-bu) | コードレビュー | 孔雀 |
...
| 6 | マルタギルド | 要確認 | なし（Manusのみ） | 中身確認→GitHub移行判断 | 孔雀 |
| 7 | モノハブ | 要確認 | なし（Manusのみ） | 中身確認→GitHub移行判断 | 孔雀 |
| 8 | 満願寺どっち？ | 要確認 | なし（Manusのみ） | 中身確認→GitHub移行判断 | 孔雀 |
| 9 | あちらさまからです | 要確認 | なし（Manusのみ） | 中身確認→GitHub移行判断 | 孔雀 |
| 10 | ハッピー鑑定士 | 要確認 | なし（Manusのみ） | 中身確認→GitHub移行判断 | 孔雀 |
...
**次のアクション:**
- [ ] 孔雀: セキュリティレビュー実施（JWT実装、SSO、入力バリデーション）
- [ ] 孔雀: レビュー結果をGitHub Issueまたはこのファイルのレビューログに記録
- [ ] 中さん: レビュー指摘対応
