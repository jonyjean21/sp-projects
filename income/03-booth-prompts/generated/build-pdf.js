...
<div class="outro-page page-break">
  ...
  <p>これらの「ありふれた技術」と「AIプロンプト」の組み合わせで、月10万円の副業収入を実現しました。</p>
  ...
  <div class="author-box">
    ...
    <p>WordPress &times; GAS &times; Firebase &times; Claude Code を組み合わせた自動化ワークフローを構築し、月10万円の副業収入を実現。WordPress情報メディア（月3,000セッション）では、大会情報の自動収集から記事投稿まで、可能な限りの作業を自動化。「面倒なことは全部AIにやらせて、人間は創造的なことだけやる」がモットー。</p>
