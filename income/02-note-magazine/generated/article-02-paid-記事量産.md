...
「それ品質は大丈夫なの？」という疑問には答える。**大丈夫だ。というかそれが全て**。この記事では、MOLKKY HUBで実際に使っているコードと設定を全部公開する。
...
モルックで言えば、競合サイトが20記事しかない状況で俺が100記事を持っていれば、Googleは「このサイトはモルックについて詳しい」と判断し始める。これが「トピッククラスター」という概念だ。
