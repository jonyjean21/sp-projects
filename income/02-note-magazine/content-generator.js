...
const ARTICLE_TOPICS = [
  ...
  // === ここが空白地帯 ===
  // Claude Code の「リアルな使い方」を発信してる日本人はほぼゼロ
  // 実際にやってる人が書くから信頼性が段違い → ブルーオーシャン
  {
    id: 9,
    title: "Claude Codeはターミナルで使え。ブラウザとの違いを誰も教えてくれなかった",
    type: "free",
    hook: "知られていない事実",
    points: [
      "ターミナル版とウェブ版で何が違うか（実際に使って分かったこと）",
      "「記憶してる」ように見える理由 = ファイルを毎回読んでるだけ",
      "CLAUDE.md と SESSION-HANDOFF.md の仕組み",
      "副業で使うならどっちで何をやるべきか",
    ],
  },
  {
    id: 10,
    title: "Claude Codeで稼ぐ人が全員やってる「引き継ぎ設計」とは何か",
    type: "paid",
    hook: "プロだけ知ってる設計術",
    points: [
      "AIは何も覚えていない → だからファイルに全部書く",
      "SESSION-HANDOFF.md の実際の中身を公開",
      "CLAUDE.md にどこまで書くか",
      "この設計があるとAIが毎回文脈を把握して即動ける",
    ],
  },
  {
    id: 11,
    title: "Claude Codeを「ターミナルで動かす」までの全手順（つまずいた場所も全部書く）",
    type: "free",
    hook: "入門ハウツー",
    points: [
      "インストールから最初の動作確認まで",
  ...
  {
    id: 12,
    title: "Claude Codeで副業するときの「チーム設計」— AIに役割を持たせると何が変わるか",
    type: "paid",
    hook: "発想の転換",
    points: [
      "Content / Sales / Tech の3役割に分ける理由",
      "サブエージェントを並列で動かして時間を圧縮する方法",
      "俺が実際に使ってるプロンプト設計",
      "月2時間の作業で月収¥10万を回す仕組み",
    ],
  },
  {
    id: 13,
